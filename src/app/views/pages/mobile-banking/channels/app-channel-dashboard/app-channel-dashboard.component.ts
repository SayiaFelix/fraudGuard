...
@Component({
  ...
  templateUrl: './app-channel-dashboard.component.html',
  styleUrls: ['./app-channel-dashboard.component.scss'],
  providers: [DatePipe],
})
 ...
 * Starter-component
 */
export class AppChannelDashboardComponent implements OnInit {
  /**
   * Apex chart
   */
