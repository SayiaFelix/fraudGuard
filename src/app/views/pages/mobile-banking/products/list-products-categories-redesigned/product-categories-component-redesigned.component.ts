...
@Component({
  selector: 'app-product-categories-redesigned',
  templateUrl: './product-categories-component-redesigned.component.html',
  styleUrls: ['./product-categories-component-redesigned.component.scss'],
  providers: [DatePipe],
})
 ...
 * Starter-component
 */
export class ProductCategoriesComponentRedesigned implements OnInit {
