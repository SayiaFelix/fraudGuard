...
@Component({
  selector: 'app-new-linked-accounts',
  templateUrl: './new-linked-accounts.component.html',
  styleUrls: ['./new-linked-accounts.component.scss'],
  providers: [
    NgbActiveModal
  ]
})
export class NewLinkedAccountsComponent implements OnInit {
