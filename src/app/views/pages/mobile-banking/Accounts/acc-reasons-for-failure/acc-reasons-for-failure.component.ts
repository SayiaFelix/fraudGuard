...
@Component({
  selector: 'app-acc-reasons-for-failure',
  templateUrl: './acc-reasons-for-failure.component.html',
  styleUrls: ['./acc-reasons-for-failure.component.scss'],
})

export class AccReasonsForFailureComponent implements OnInit {
