...
@Component({
  selector: 'app-unblocked-accounts',
  templateUrl: './unblocked-accounts.component.html',
  styleUrls: ['./unblocked-accounts.component.scss']
})
export class UnblockedAccountsComponent implements OnInit {
  ...
  tempProductData = [
    {
      ...
      status: true,
      UnblockedBy:'Kari',
      UnblockedOn: '12-02-2023',
    },
    {
      id: 2,
      PhoneNumber: '0725143265',
  ...
  openUnblockModal(formData: any) {
    ...
    this.modalRef.componentInstance.body= "Do you want to unblock this account?";
    this.modalRef.result.then((result) => {
      if (result === 'success') {
        Swal.fire('Unblocked Successfully',  'Account has been unblocked successfully.',  'success')
        .then
