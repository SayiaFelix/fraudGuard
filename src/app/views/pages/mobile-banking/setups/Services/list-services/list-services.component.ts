...
export class ListServicesComponent implements OnInit {
  ...
  columns = [
    { name: '#', prop: 'id' },
    { name: 'Client Id', prop:'name' },
    { name: 'Host Code', prop:'atmCode' },
    { name: 'Channel', prop:'atmCode' },
    { name: 'Trans Type', prop:'atmCode' },
    { name: 'Trans Code', prop:'atmCode' },
    { name: 'Description', prop:'atmCode' },
  ...
  public editService(formData: any) {
    this.modalRef = this.modalService.open(AddServiceComponent, {centered: true, size: "md"});
  ...
  triggerEvent(data: string) {
    ...
    if (eventData.action == 'View') {
      ...
      this.editService(eventData.row);
    }
